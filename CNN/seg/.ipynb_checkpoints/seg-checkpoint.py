...
def make_dataset(DATASET_SIZE=100, IMG_SIZE=128,resize=128,validation_split=0.80,shift=False,agn=True,p=True,sigma=0.25):
    home = expanduser("~")
...
def plot_results(x_val,y_val,prediction,seg_cmap=mpl.cm.viridis,spath=None):
    ...
    for j in random.choices(idx,k=5):
